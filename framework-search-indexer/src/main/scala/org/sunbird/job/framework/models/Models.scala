package org.sunbird.job.framework.models

import org.sunbird.job.framework.task.FrameworkSearchIndexerConfig
import java.util
import scala.collection.JavaConverters._

case class CompositeIndexer(graphId: String, objectType: String, identifier: String, messageId: String, message: util.Map[String, Any], config: FrameworkSearchIndexerConfig) {
