...
import org.sunbird.job.framework.compositesearch.helpers.DIALCodeMetricsIndexerHelper
...
class DIALCodeMetricsIndexerFunction(config: FrameworkSearchIndexerConfig,
